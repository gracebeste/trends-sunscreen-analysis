...
pytrends.build_payload(keywords, cat=0, timeframe='2020-01-01 2024-12-31', geo='US-DC', gprop='')

# Fetch interest over time
data = pytrends.interest_over_time()
data.to_csv('/Users/gracebeste/documents/trends-sunscreen-analysis/src/sentiment/google/raw-data/usa-dc_weekly_trends_2020_2024.csv')

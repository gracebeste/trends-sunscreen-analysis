...
base_url = f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/USA/2024-01-01/2024-12-31?key={VC_API_KEY}"
...
params = {
    ...
    "startDateTime": "2024-01-01", # Starting in Jan 2024
    "endDateTime": "2024-12-31" # Ending in Dec 2024 --> VC's row count limit is 1000/day, so I'm downloading 2 years maximum per dataset
}
...
if response.status_code == 200:
    ...
    with open("/Users/gracebeste/Documents/trends-sunscreen-analysis/src/weather/visual-crossing/raw-data/usa_daily_weather_2024.csv", "wb") as file:
        file.write(response.content)
    print("Data saved to 'usa_daily_weather_2024.csv'")
else:

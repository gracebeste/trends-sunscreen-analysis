...
base_url = f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/USA/2020-01-01/2021-12-31?key={VC_API_KEY}"
...
params = {
    ...
    "startDateTime": "2020-01-01", # Starting in 2020
    "endDateTime": "2021-12-31" # Ending in 2021 --> VC's row count limit is 1000/day, so we're downloading 2 years maximum per dataset
}
